...
public class CrawlerController {
    ...
    public Object getGalleryUrl(@PathVariable(value = "pageNum", required = false) String pageNum,
        ...
        String realGalleryNum = ((List<String>) crawlerService.getPageUrl(pageNum).get("galleryList")).get(Integer.parseInt(galleryNum) - 1);
        urlMap = crawlerService.getPicUrl(realGalleryNum);
        return ResultRest.success(urlMap);
    }
}
